        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNinVerified = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    TotalVouchPoints = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredVouchPoints = table.Column<int>(type: "integer", nullable: false),
                    IsDiscoveryEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouches_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vouches_Users_VoucherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialComplaint = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    ResolutionStage = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    AdminNotes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    FinalDecision = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentContentPreview = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    ParentSenderName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    InitialDepositPercentage = table.Column<decimal>(type: "numeric", nullable: false),
                    IsSecondPhaseFunded = table.Column<bool>(type: "boolean", nullable: false),
                    QrToken = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true),
                    QrTokenExpiry = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Version = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ReferenceType_ReferenceId",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouches_ServiceId",
                table: "Vouches",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Vouches_VoucherId",
                table: "Vouches",
                column: "VoucherId");
